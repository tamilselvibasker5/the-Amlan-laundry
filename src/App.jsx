...
const translations = {
 en: {
  ...
  whoCanJoin: {
   ...
   desc5: 'high returns opportunity. Complete business setup with ongoing mentorship and support.'
  },
  // Business Section
  business: {
   title: 'Business',
   ...
   <div className="relative z-20 max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 text-center pointer-events-none" style={{ marginTop: '0rem' }}>
    <RevealOnScroll delay={100}>
     <div className="mb-6 md:mb-8 flex justify-center" style={{ marginTop: '1.5rem' }}>
      <img loading="lazy"
       src="/images/The amlan logo transparent.webp"
       alt="The Amlan Logo"
     ...
     <RevealOnScroll className="relative order-2 md:order-1">
      ...
      <div className="relative flex justify-center py-20">
       ...
       <div className="lg-washer-float relative">
        <img
         src="/images/LG 10 kg dryer.webp"
         ...
         {reasons.map((item, i) => (
          ...
          >
           <div className="w-12 h-12 bg-white flex items-center justify-center group-hover:scale-110 transition-transform flex-shrink-0 overflow-hidden rounded">
            {i === 0 && <img loading="lazy" src="/images/Social welfare-focused initiative.webp" alt="Social welfare" className="w-full h-full object-cover" />}
            {i === 1 && <img loading="lazy" src="/images/low inveztment.webp" alt="Scalable Business" className="w-full h-full object-cover" />}
            {i === 2 && <img loading="lazy" src="/images/complete support.webp" alt="Complete support" className="w-full h-full object-cover" />}
            {i === 3 && <img loading="lazy" src="/images/modern machinery.webp" alt="Modern machinery" className="w-full h-full object-cover" />}
            {i === 4 && <img loading="lazy" src="/images/good income opportunity.webp" alt="Good income opportunity" className="w-full h-full object-cover" />}
           </div>
       ...
       <div className="flex-shrink-0 w-full lg:w-auto flex justify-center lg:justify-end">
        <div className="relative w-[400px] h-[500px] md:w-[450px] md:h-[550px]">
         ...
         <div className="absolute top-0 right-0 group">
          <img loading="lazy"
           src="/images/west bengal peoples.webp"
      ...
      {categories.map((item, i) => (
       <div key={i} className="who-card">
        {i === 0 ? (
         ...
         <img loading="lazy"
          src="/images/Cooking up some love in my favorite corner of the house!.webp"
         ...
         <img loading="lazy"
          src="/images/Serva Dharma Ashram Trust India help sick, physical challenged people_.webp"
         ...
         <img loading="lazy"
          src="/images/Sahaj ties up with Techno India to skill 1 lakh rural youth.webp"
         ...
         <img loading="lazy"
          src="/images/A Guide to Starting a Small Business in Mexico as an American Entrepreneur.webp"
...
const Business = () => {
 ...
 return (
  <section id="business" className="py-20 relative overflow-hidden z-10" style={{
   background: '#ffffff',
   backgroundImage: 'url("/images/West Bengal state map, administrative division of India_ Vector illustration_.webp")',
