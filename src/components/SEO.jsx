...
const SEO = () => {
 const structuredData = {
  ...
  "@graph": [
   ...
   },
   {
    ...
    "url": "https://www.theamlanlaundry.com/",
    "name": "Laundry Business in Kolkata | Amlan Laundry",
    "isPartOf": {
     "@id": "https://www.theamlanlaundry.com/#website"
    },
    "about": {
   ...
   },
   {
    ...
    "image": "https://www.theamlanlaundry.com/images/The%20amlan%20logo%20transparent.webp",
    "description": "Start a profitable laundry business in Kolkata. Get commercial LG equipment, expert training, & marketing support.",
    "telephone": "+917044428460",
    "email": "contact@theamlanlaundry.com",
    "address": {
     "@type": "PostalAddress",
    ...
    "mainEntity": [
     {
      ...
      "acceptedAnswer": {
       "@type": "Answer",
       "text": "The Amlan Laundry is a transformative, laundry business and Self-Income Generating Program in West Bengal, India."
      }
     },
     {
      "@type": "Question",
 ...
 return (
  <Helmet>
   <title>Laundry Business in Kolkata | Amlan Laundry</title>
   <meta name="description" content="Start a profitable laundry business in Kolkata. Get commercial LG equipment, expert training, & marketing support with The Amlan Laundry." />
   ...
   {/* Open Graph Tags */}
   <meta property="og:title" content="Laundry Business in Kolkata | Amlan Laundry" />
   <meta property="og:description" content="Start a profitable laundry business in Kolkata. Get commercial LG equipment, expert training, & marketing support with The Amlan Laundry." />
   <meta property="og:image" content="https://www.theamlanlaundry.com/images/The%20amlan%20logo%20transparent.webp" />
   <meta property="og:url" content="https://www.theamlanlaundry.com/" />
   <meta property="og:type" content="website" />

   {/* Twitter Card Tags */}
   <meta name="twitter:card" content="summary_large_image" />
   <meta name="twitter:title" content="Laundry Business in Kolkata | Amlan Laundry" />
   <meta name="twitter:description" content="Start a profitable laundry business in Kolkata. Get commercial LG equipment, expert training, & marketing support with The Amlan Laundry." />
   <meta name="twitter:image" content="https://www.theamlanlaundry.com/images/The%20amlan%20logo%20transparent.webp" />
